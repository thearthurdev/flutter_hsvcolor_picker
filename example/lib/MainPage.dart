...
class MainPageState extends State<MainPage> {
  ...
  List<MainItem> items = [
    new MainItem(
        ...
        text: "Slider",
        page: new SliderPickerPage()),
    new MainItem(
        index: 1,
        icon: Icons.gradient,
        text: "Palette",
        page: new PalettePickerPage()),
    null,
    new MainItem(
        index: 2,
        icon: Icons.tune,
        text: "RGB Picker",
        page: new RGBPickerPage()),
    new MainItem(
        index: 3,
        icon: Icons.tune,
        text: "HSV Picker",
        page: new HSVPickerPage()),
    new MainItem(
        index: 4,
        icon: Icons.tune,
        text: "Wheel Picker",
        page: new WheelPickerPage()),
    null,
    new MainItem(
        index: 5,
        icon: Icons.color_lens,
        text: "Palette Hue Picker",
        page: new PaletteHuePickerPage()),
    new MainItem(
        index: 6,
        icon: Icons.color_lens,
        text: "Palette Saturation Picker",
        page: new PaletteSaturationPickerPage()),
    new MainItem(
        index: 7,
        icon: Icons.color_lens,
        text: "Palette Value Picker",
        page: new PaletteValuePickerPage()),
    null,
    new MainItem(
        index: 8,
        icon: Icons.mode_edit,
        text: "Hex Picker",
        page: new HexPickerPage()),
    new MainItem(
        index: 9,
        icon: Icons.mode_edit,
        text: "Alpha Picker",
        page: new AlphaPickerPage()),
    new MainItem(
        index: 10,
        icon: Icons.mode_edit,
        text: "Swatches Picker",
        page: new SwatchesPickerPage()),
    null,
    new MainItem(
        index: 11,
        icon: Icons.color_lens,
  ...
  ThemeData themeLight =
      new ThemeData(brightness: Brightness.light, platform: TargetPlatform.iOS);
  ThemeData themeDark =
      new ThemeData(brightness: Brightness.dark, platform: TargetPlatform.iOS);
  ...
  Widget buildAppBar() {
    return new AppBar(
        ...
        leading: new IconButton(
            ...
            icon: new IconTheme(
                data: this.theme.iconTheme, child: new Icon(Icons.dehaze))),
